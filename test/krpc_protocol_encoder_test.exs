defmodule KRPCProtocol.Encoder.Test do
  ...
  test "if KRPCProtocol DHT query get_peers works" do
    str = KRPCProtocol.encode(:get_peers, node_id: node_id(), info_hash: info_hash(), tid: "aa")
  ...
  test "if announce_peer query with options" do
    str =
      KRPCProtocol.encode(:announce_peer,
        node_id: node_id(),
        info_hash: info_hash(),
        token: "aoeusnth",
        tid: "aa",
    ...
    result =
      "d1:ad2:id20:aaaaaaaaaaaaaaaaaaaa9:info_hash20:" <>
  ...
  test "if announce_peer query with options with implied_port" do
    ...
    result =
      "d1:ad2:id20:aaaaaaaaaaaaaaaaaaaa12:implied_porti1e9:info_hash20:" <>
        "bbbbbbbbbbbbbbbbbbbb4:porti2342e5:token8:aoeusnthe1:q13:announce_peer1:" <>
        "t2:aa1:y1:qe"
  ...
  test "find_node_reply with an IPv6 address" do
    params = [
      node_id: "aa",
      nodes: [{"aa", {9797, 9797, 9797, 9797, 9797, 9797, 9797, 9797}, 9797}],
      tid: "bb"
    ]
  ...
  test "get_peers_reply with an IPv6 address" do
    params = [
      node_id: "a",
      values: [{{9797, 9797, 9797, 9797, 9797, 9797, 9797, 9797}, 9797}],
      tid: "b",
      token: "c"
    ]
